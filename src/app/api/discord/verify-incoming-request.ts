...
//     return nacl.sign.detached.verify(Buffer.from(timestamp + rawBody), Buffer.from(signature, "hex"), Buffer.from(appPublicKey, "hex"));
// };
 ...
 */
export async function verifyInteractionRequest(request: Request, appPublicKey?: string): Promise<VerifyDiscordRequestResult> {
